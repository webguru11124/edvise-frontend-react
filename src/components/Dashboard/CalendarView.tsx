            ...
            <div key={day.date} className='py-2'>
              <button
                ...
                className={classNames(
                  ...
                  !day.isSelected && !day.isToday && !day.isCurrentMonth
                    ? 'text-gray-400'
                    : '',
                  day.isSelected && day.isToday ? 'bg-skyblue-600' : '',
                  day.isSelected && !day.isToday ? 'bg-skyblue-400' : '',
              ...
              >
                <time dateTime={day.date}>
                  {(day?.date?.toString().split('-').pop() || '').replace(
                    /^0/,
                    ''
                  )}
                </time>
              ...
              >
                <div>
                  <Menu.Button className='-m-2 flex items-center rounded-full p-1.5 text-gray-500 hover:text-gray-600'>
                    ...
                    <MoreVert className='h-6 w-6' aria-hidden='true' />
                  </Menu.Button>
                </div>
                ...
                >
                  <Menu.Items className='absolute right-0 z-10 mt-2 w-36 origin-top-right rounded-md bg-white shadow-lg focus:outline-none'>
                    <div className='py-1'>
                      <Menu.Item>
                        {({ active }) => (
                          <button
